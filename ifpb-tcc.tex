...
\include{estrutura/textuais/desenvolvimento/embasamento-teorico}        % Embasamento teórico
\include{estrutura/textuais/desenvolvimento/atividades-realizadas}      % Veículos
